...
class AddDepartmentScreen extends StatefulWidget {
  ...
  const AddDepartmentScreen({super.key, required this.loggedInUser});
...
class _AddDepartmentScreenState extends State<AddDepartmentScreen> {
  ...
  Future<void> _addDepartment() async {
    ...
    try {
      final newDepartment = Department(name: departmentName);

      final result = await departmentController.createDepartment(newDepartment);

      if (result == 'Status 1000') {
        setState(() {
          _message = 'Department created successfully!';
          _isSuccess = true;
        });
      ...
      setState(() {
        _message = 'Error creating Department';
        _isSuccess = false;
      });
    }
  }
          ...
          children: [
            ...
            Expanded(
              child: Container(
                ...
                child: _buildAddDepartmentScreen(),
              ),
            ),
          ],
        ),
  ...
  Widget _buildAddDepartmentScreen() {
    return Column(
